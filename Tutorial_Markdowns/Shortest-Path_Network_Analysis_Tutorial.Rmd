...
stringSubset <- stringNet[experimental >= 400] 
setnames(aliases, "#string_protein_id", "stringID")

graph <- igraph::graph_from_edgelist(as.matrix(stringSubset[, .(protein1, protein2)]))
